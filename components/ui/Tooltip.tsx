...
// Ported from revoke.cash, so the two apps' tooltips behave identically: hover and focus to open,
// safe-polygon hover-out, flip and shift against the viewport edges, and a portal so overflow clipping
// in cards cannot cut the bubble off.
import {
  arrow,
  autoUpdate,
  FloatingArrow,
