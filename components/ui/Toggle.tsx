...
interface Props {
  ...
  label: string;
  description?: string;
  // Detail worth having but not worth a line: rendered as a small circled i after the label.
  tooltip?: ReactNode;
  disabled?: boolean;
}

const Toggle = ({ checked, onChange, label, description, tooltip, disabled }: Props) => (
