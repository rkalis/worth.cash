...
//   2. The Covalent support type is gone, so the two chains that used it were moved onto Etherscan
//      and Blockscout respectively.
import { ChainId } from '@revoke.cash/chains';
import { Chain, type DeployedContracts, SupportType } from 'lib/chains/Chain';
